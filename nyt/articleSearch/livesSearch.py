...
def execute():
    ...
    for (start,end) in periods:
        ...
        for page in validPages:
            ...
            url = f'https://api.nytimes.com/svc/search/v2/articlesearch.json?begin_date={start}&end_date={end}&fq=kicker.contains%3A({KICKER})&page={page}&api-key={apiKey}'
            ...
            if 'response' in rj and 'docs' in rj['response']:
                ...
                if querySeen>=queryHits:
                    ...
                    print("Last page. Moving to next query")
                    break
